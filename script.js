...
async function displayMovie(id) {
  ...
  // This gets the modal to close after clicking on the object
  if (spana.length > 0) {
    var jr = jsonResponse;
    ...
    text.innerHTML = `
        ...
        <div class="inflex"> <span><p>⭐&nbsp;${jr.vote_average} </p></span> <p>${jr.genres[0].name} </p><h3>${jr.original_title} </h3><p>${jr.runtime} min | ${jr.release_date}</p><img src="https://image.tmdb.org/t/p/w500/${jr.poster_path}" alt="Poster of ${jr.original_title}"> <p>Overview: ${jr.overview} </p>
